...
for (let i = 0; i < slides.length; i++) {
	const dot = document.createElement('div')				//Crée un élément <di> pour présenter un point
...
//---Flèche droite--
arrowRight.addEventListener('click' , () => {										//Ajouter un écouteur de clic sur la fléche gauche
